#!/bin/bash
# Double-click this to launch the NBA DFS optimizer.
# It starts the local app and opens it in your browser. Close the Terminal
# window (or press Ctrl+C) to stop it.

cd "$(dirname "$0")/nba" || { echo "Can't find the nba folder next to this launcher."; read -r; exit 1; }
...
echo "  Launching the NBA optimizer…  (this window can be minimized)"
exec "$PY" app.py
