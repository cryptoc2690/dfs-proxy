#!/bin/bash
# Double-click this to launch the NFL DFS optimizer.
# It starts the local app and opens it in your browser. Close the Terminal
# window (or press Ctrl+C) to stop it.

cd "$(dirname "$0")/nfl" || { echo "Can't find the nfl folder next to this launcher."; read -r; exit 1; }
...
echo "  Launching the NFL optimizer…  (this window can be minimized)"
exec "$PY" app.py
